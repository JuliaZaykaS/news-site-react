...
export default {
  ...
  // cacheDirectory: "C:\\Users\\yu.zajka\\AppData\\Local\\Temp\\jest",
  ...
  // если конфиг лежит не в корне проекта, укажем путь до корневой папки
  rootDir: "../../",
  ...
  reporters: [
    "default",
    ["jest-html-reporters", {
      "publicPath": "<rootDir>/html-reports/jest",
