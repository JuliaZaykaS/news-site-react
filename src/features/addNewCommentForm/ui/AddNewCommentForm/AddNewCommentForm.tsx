...
const AddNewCommentForm = typedMemo(
    (props: AddNewCommentFormProps) => {
        ...
        const onInputChange = useCallback(
            (value: string) => {
                dispatch(
                    addNewCommentFormActions.setText(value),
                );
            },
            [dispatch],
        );
